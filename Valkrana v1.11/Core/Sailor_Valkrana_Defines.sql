...
/*INSERT INTO Types (Type, Kind) VALUES ('MODIFIER_SAILOR_ALL_CITIES_GW_SLOTS', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES ('MODIFIER_SAILOR_ALL_CITIES_GW_SLOTS', 'COLLECTION_ALL_CITIES', 'EFFECT_ADJUST_EXTRA_GREAT_WORK_SLOTS');
INSERT INTO GameModifiers (ModifierId)
VALUES	('SAILOR_NEGATIVE_RELIC_SLOT');

INSERT INTO Modifiers (ModifierId, ModifierType, Permanent)
VALUES	('SAILOR_NEGATIVE_RELIC_SLOT', 'MODIFIER_SAILOR_ALL_CITIES_GW_SLOTS', 1);

INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES	('SAILOR_NEGATIVE_RELIC_SLOT', 'Amount', 0),
		('SAILOR_NEGATIVE_RELIC_SLOT', 'BuildingType', 'BUILDING_LIBRARY'),
		('SAILOR_NEGATIVE_RELIC_SLOT', 'GreatWorkSlotType', 'GREATWORKSLOT_RELIC');*/

-- // Modifiers
-- All relics get 
/*INSERT INTO GreatWorkModifiers (GreatWorkType, ModifierId)
SELECT DISTINCT GreatWorkType, 'SAILOR_VALKRANA_UA_RELIC_GSP_'||RowID
FROM GreatWorks WHERE GreatWorkObjectType = 'GREATWORKOBJECT_RELIC';

INSERT INTO Modifiers (ModifierId,					ModifierType, OwnerRequirementSetId, SubjectRequirementSetId)
SELECT	'SAILOR_VALKRANA_UA_RELIC_GSP_'||RowID,			'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', NULL, NULL
FROM GreatWorks WHERE GreatWorkObjectType = 'GREATWORKOBJECT_RELIC';

INSERT INTO ModifierArguments (ModifierId, Name, Value)
SELECT	'SAILOR_VALKRANA_UA_RELIC_GSP_'||RowID, 'Amount', 2
FROM GreatWorks WHERE GreatWorkObjectType = 'GREATWORKOBJECT_RELIC';

INSERT INTO ModifierArguments (ModifierId, Name, Value)
SELECT	'SAILOR_VALKRANA_UA_RELIC_GSP_'||RowID, 'GreatPersonClassType', 'GREAT_PERSON_CLASS_SCIENTIST'
FROM GreatWorks WHERE GreatWorkObjectType = 'GREATWORKOBJECT_RELIC';*/
...
VALUES	-- Skeleton Abilities
		...
		-- Relic GSP
		--('SAILOR_VALKRANA_UA_RELIC_GSP',			'MODIFIER_SINGLE_CITY_ADJUST_GREAT_PERSON_POINT', 'SAILOR_IS_VALKRANA_REQUIREMENTS', NULL),
		-- Barrier Spell
...
VALUES	('SAILOR_VALKRANA_UU_ABILITY_LIBRARY', 'AbilityType', 'ABILITY_SAILOR_VALKRANA_UU_LIBRARY'),
		...
		--('SAILOR_VALKRANA_UA_RELIC_GSP', 'Amount', 2),
		--('SAILOR_VALKRANA_UA_RELIC_GSP', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_SCIENTIST'),
...
-- // Religion - Cult of Ilyana
/*INSERT INTO Types (Type, Kind) VALUES ('RELIGION_SAILOR_COI', 'KIND_RELIGION');
INSERT INTO Religions (ReligionType, Name, IconString, Color)
VALUES	('RELIGION_SAILOR_COI', 'LOC_RELIGION_SAILOR_COI', 'Il', 'COLOR_RELIGION_PANTHEON');
-- Need to add moment.

INSERT INTO FavoredReligions (LeaderType, ReligionType) VALUES ('LEADER_SAILOR_VALKRANA', 'RELIGION_SAILOR_COI');*/